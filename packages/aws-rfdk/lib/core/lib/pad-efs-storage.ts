 ...
 * is no longer allowed to burst throughput and you will be limited in throughput to the greater of 1MB/s
 * or the throughput dictated by the amount of data stored in your filesystem.
 *
